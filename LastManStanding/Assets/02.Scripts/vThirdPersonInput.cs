...
namespace Invector.CharacterController
{
    public class vThirdPersonInput : MonoBehaviourPun
    {
        ...
        public KeyCode crouchInput = KeyCode.Mouse1;
        ...
        protected virtual void Start()
        {
            ...
            {
                isAttack = GameObject.Find("VBOT_:RightToe_End_end").GetComponent<Collider>();
                isAttack.enabled = false;
                CharacterInit();
            }
        }
        ...
        public virtual void CrouchInput()
        {
            ...
            {
                cc.animator.SetBool("isCrouch", true);
                cc.keepcrouch = false;
            }

            else if (Input.GetKeyUp(crouchInput))
            {
                cc.animator.SetBool("isCrouch", false);
                cc.keepcrouch = true;
            }
        }
        [PunRPC]
        ...
        IEnumerator AttackInput()
        {
            ...
            {
                isAttack.enabled = true;
                cc.animator.SetBool("isAttack", true);
                yield return new WaitForSeconds(1f);
                isAttack.enabled = false;
            }

            else
                cc.animator.SetBool("isAttack", false);
        }
